...
################################### above preset by ??? (maybe Milan since from Pisces)
################################### below DBL stuff
...
alias ...="cd ../.."
alias ....="cd ../../.."
alias rmpycache='docker run --rm -it -v "/home/dblyon/agotool/:/agotool/" ubuntu bash -c "rm -rf /agotool/app/python/__pycache__"'
alias five="cd /mnt/mnemo5/dblyon"
alias four="cd /mnt/mnemo4/dblyon"
...
alias config='/usr/local/bin/git --git-dir=~/.cfg/ --work-tree=~'
#alias config='/usr/bin/git --git-dir=/home/dblyon/.cfg/ --work-tree=/home/dblyon'
...
__conda_setup="$('/home/dblyon/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/dblyon/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/dblyon/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/dblyon/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
